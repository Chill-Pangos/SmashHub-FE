export default {
  ...
  "systemLogs": {
    ...
    "cronLogs": "Cron Logs",
    "auditLogsData": "Action Logs Data",
    ...
    "noEventsData": "No events data",
    "noEventsFound": "No events found for the selected type",
    ...
    "details": {
      ...
      "apiLogDetail": "API Log Detail",
      "logDetail": "Log Detail",
      "detailDesc": "Detailed view of the selected system log.",
