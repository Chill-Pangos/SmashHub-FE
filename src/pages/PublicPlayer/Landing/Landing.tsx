        ...
        <section className="relative w-full overflow-hidden border-b border-border">
          ...
          <div className="relative z-10 container mx-auto px-6 py-24 md:py-32 flex flex-col items-center text-center">
            <div className="inline-flex items-center rounded-full border border-primary/20 bg-primary/10 px-3 py-1 text-sm font-medium text-primary mb-8 backdrop-blur-sm">
              ...
              {t("publicPlayer.landing.premierPlatform")}
            </div>
            <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-foreground mb-6 drop-shadow-sm max-w-4xl">
              {t("publicPlayer.landing.elevateExperience").replace("Your Experience", "")} <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary/60">{t("publicPlayer.landing.title")}</span> {t("publicPlayer.landing.elevateExperience").includes("Your Experience") ? "Experience" : ""}
            </h1>
            <p className="text-xl text-muted-foreground max-w-2xl mb-10 leading-relaxed drop-shadow-sm">
              {t("publicPlayer.landing.hubDesc")}
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                {t("publicPlayer.landing.getStarted")}
              ...
              >
                {t("publicPlayer.landing.browseTournaments")}
              </Link>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 bg-background">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">{t("publicPlayer.landing.everythingYouNeed")}</h2>
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">{t("publicPlayer.landing.description1")}</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="rounded-2xl border border-border bg-card p-8 shadow-sm transition-all hover:shadow-md hover:border-primary/30 group">
                ...
                <h3 className="text-xl font-bold mb-3">{t("publicPlayer.landing.liveMatchTracking")}</h3>
                <p className="text-muted-foreground leading-relaxed">{t("publicPlayer.landing.liveMatchDesc")}</p>
              </div>
              ...
              <div className="rounded-2xl border border-border bg-card p-8 shadow-sm transition-all hover:shadow-md hover:border-primary/30 group">
                ...
                <h3 className="text-xl font-bold mb-3">{t("publicPlayer.landing.officialElo")}</h3>
                <p className="text-muted-foreground leading-relaxed">{t("publicPlayer.landing.officialEloDesc")}</p>
              </div>
              ...
              <div className="rounded-2xl border border-border bg-card p-8 shadow-sm transition-all hover:shadow-md hover:border-primary/30 group">
                ...
                <h3 className="text-xl font-bold mb-3">{t("publicPlayer.landing.seamlessOrganization")}</h3>
                <p className="text-muted-foreground leading-relaxed">{t("publicPlayer.landing.seamlessDesc")}</p>
              </div>
            </div>
          </div>
        </section>
    ...
    <div className="px-6 py-12">
      <div className="max-w-4xl space-y-8">
        <div className="space-y-2">
          <h1 className="text-3xl font-semibold">{t("publicPlayer.landing.portalDesc")}</h1>
          <p className="text-muted-foreground">
            {t("publicPlayer.landing.selectPortal")}
          </p>
        </div>
