    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      <div className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">
          Select a category to view your registration status or find a team.
        </p>
      </div>
  ...
  return (
    <div className="rounded-xl border border-border bg-card p-6 shadow-sm space-y-6">
      <div className="flex justify-between items-start">
        <div>
          <h3 className="text-xl font-bold text-primary">Your Entry</h3>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="space-y-2">
          <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Entry Name / Team</p>
        ...
        <div className="space-y-2">
          ...
          <p className="text-lg font-medium flex items-center gap-2">
            {entry.isConfirmed ? (
              ...
              <span className="text-orange-500">Pending Confirmation</span>
            )}
          </p>
        </div>
        <div className="space-y-2">
        ...
        {entry.captain && (
          <div className="space-y-2">
            <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Captain</p>
      ...
      {isCaptain && (
        <div className="pt-4 border-t border-border mt-6">
          <h4 className="text-sm font-bold uppercase tracking-wider text-muted-foreground mb-4">Captain Actions</h4>
      ...
      {isTeamFormat && (
        <>
          <div className="flex items-center justify-between mt-8 mb-4">
            <h3 className="text-lg font-bold">Recruiting Teams</h3>
