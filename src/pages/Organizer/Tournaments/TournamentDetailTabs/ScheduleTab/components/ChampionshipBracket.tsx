    ...
    <div className="bg-card border border-border rounded-xl p-6 overflow-x-auto">
      <div className="flex gap-12 min-w-[800px]">
        <div className="flex-1 space-y-8">
          <h4 className="text-sm font-bold text-muted-foreground mb-6 text-center">Quarter-Finals</h4>
        ...
        <div className="flex-1 space-y-8 flex flex-col justify-around">
          <div>
            <h4 className="text-sm font-bold text-muted-foreground mb-6 text-center">Semi-Finals</h4>
        ...
        <div className="flex-1 space-y-8 flex flex-col justify-center">
          <div>
            <h4 className="text-sm font-bold text-chart-4 mb-6 text-center">Grand Final</h4>
            <div className="bg-background border border-border rounded-lg p-3 relative opacity-50 border-dashed">
              <div className="flex justify-between text-xs text-muted-foreground mb-3">
                ...
                <span className="font-bold uppercase">UPCOMING</span>
              </div>
              <div className="space-y-2">
                <div className="flex justify-between items-center text-sm">
                  <span className="text-muted-foreground">Winner SF 1</span>
                  <span>-</span>
                </div>
                <div className="flex justify-between items-center text-sm">
                  <span className="text-muted-foreground">Winner SF 2</span>
                  <span>-</span>
                </div>
              </div>
            </div>
