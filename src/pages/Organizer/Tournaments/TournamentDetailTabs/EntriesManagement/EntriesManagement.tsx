...
const MOCK_ENTRIES: Entry[] = [
  {
    id: 1,
    entryIdString: "#ENT-0942",
    name: "Cybernetics Prime",
    categoryId: 1,
    categoryName: "Pro Men's Open",
    captainId: 101,
    ...
    updatedAt: "",
    members: [
      { id: 1, entryId: 1, userId: 101, eloAtEntry: 1500 },
      { id: 2, entryId: 1, userId: 102, eloAtEntry: 1450 },
    ],
  },
  {
    id: 2,
    entryIdString: "#ENT-0943",
    name: "N/A",
    categoryId: 2,
    categoryName: "Pro Women's Open",
    captainId: 201,
  ...
  {
    id: 3,
    entryIdString: "#ENT-0945",
    name: "Quantum Strikers",
    categoryId: 3,
    categoryName: "Mixed Doubles Elite",
    captainId: 301,
    isAcceptingMembers: false,
    requiredMemberCount: 2,
    currentMemberCount: 2,
    ...
    updatedAt: "",
    members: [
      { id: 4, entryId: 3, userId: 301, eloAtEntry: 1600 },
      { id: 5, entryId: 3, userId: 302, eloAtEntry: 1550 },
    ],
  },
];
...
export default function EntriesManagement({
  ...
  // Mark `tournamentId` as intentionally unused for now (placeholder for future queries)
  void tournamentId;
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-4 bg-card border border-border rounded-xl">
        ...
        <div className="flex gap-8 px-4">
          ...
          <div className="text-right">
            ...
            <p className="text-2xl font-bold text-primary drop-shadow-auth-primary-glow">
              128
            </p>
          </div>
        </div>
      ...
      <div className="flex items-center justify-between text-sm text-muted-foreground">
        ...
        <div className="flex items-center gap-1">
          <Button
            variant="outline"
            size="sm"
            className="bg-transparent border-border h-8 px-3 hover:bg-muted"
            disabled
          >
            Prev
          </Button>
          <Button
            variant="outline"
            size="sm"
            className="bg-primary text-primary-foreground border-primary h-8 w-8 p-0 hover:bg-primary/90"
          >
            1
          </Button>
          <Button
            variant="outline"
            size="sm"
            className="bg-transparent border-border h-8 w-8 p-0 hover:bg-muted text-foreground"
          >
            2
          </Button>
          <Button
          ...
          <Button
            variant="outline"
            size="sm"
            className="bg-transparent border-border h-8 px-3 hover:bg-muted text-foreground"
          >
            Next
          </Button>
        </div>
